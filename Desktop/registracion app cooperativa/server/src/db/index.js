...
module.exports = {
    ...
    updateUser: (id, updates) => {
        ...
        if (index !== -1) {
            ...
            const allowedFields = ['full_name', 'curp', 'address', 'clave_elector', 'seccion', 'birth_date', 'license_number', 'license_type', 'document_type', 'ine_verified', 'license_verified', 'cooperativa_id', 'cooperativa_name', 'status'];
    ...
    getUsersByCooperativa: (cooperativaId) => {
        const db = readDb();
        return db.users.filter(u => u.cooperativa_id === cooperativaId);
    },
